...
class RunGame():
    def __init__(self):
        ...
        self.y_screen = int(9 * (self.infoObject.current_h / 10))
        self.x_screen = int(8 * (self.y_screen / 5))

        # Manteniendo el aspecto de 8:5
        self.screen_param = (self.x_screen, self.y_screen)
