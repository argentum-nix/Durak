...
|   La principal clase de la aplicación. Se instancia con un número específico
|   de jugadores, que, por defecto, es 6. La clase utiliza listas de 
|   atacantes y defensores, para analizar el cumplimiento de las reglas.
'''
class Juego(st.Estados_Juego): 
